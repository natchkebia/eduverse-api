...
async function main() {
  ...
  const courses = [
    ...
    {
      slug: 'test-expired-course',
      type: CourseType.COURSE,
      titleKa: 'ტესტი – ვადაგასული კურსი',
      titleEn: 'Test – Expired Course',
      descriptionKa: 'ეს კურსი არის სატესტო და ვადა უკვე გასული აქვს.',
      descriptionEn: 'This is a test course that is already expired.',
      altTextKa: 'ტესტი',
      altTextEn: 'Test',
      buttonKa: 'ტესტი',
      buttonEn: 'Test',
